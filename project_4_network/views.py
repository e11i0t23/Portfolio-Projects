...
def login_view(request):
    if request.method == "POST":
        ...
        if user is not None:
            login(request, user)
            return HttpResponseRedirect(reverse("project_4_network/index"))
        else:
            return render(request, "project_4_network/login.html", {
...
def register(request):
    if request.method == "POST":
        ...
        try:
            ...
            return render(request, "project_4_network/register.html", {
